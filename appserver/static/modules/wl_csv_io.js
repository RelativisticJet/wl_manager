...
define([
    ...
    function exportAuditCsv() {
        ...
        var filterParts = '';
        if (S.selectedCsv) filterParts += ' csv_file="' + splEscape(S.selectedCsv) + '"';
        if (S.selectedRule) filterParts += ' detection_rule="' + splEscape(S.selectedRule) + '"';
        ...
        .done(function (data) {
            ...
            var exportName = "wl_audit_export_" +
                (S.selectedCsv ? S.selectedCsv.replace(/\.csv$/i, "") + "_" : "") +
            ...
            showMsg("Exported <strong>" + results.length + "</strong> audit events" +
                (S.selectedCsv ? " for " + _.escape(S.selectedCsv) : "") + ".", "success");
            restPost({
                action: "log_event",
